...
namespace rm_behavior_tree{
    ...
    private:
        ...
        const std::string tree_path = "/home/hannah/BTLibraryBased_Decision/src/rm_behavior_tree/rmucTree.xml";
        const std::string test_tree_path = "/home/hannah/BTLibraryBased_Decision/src/rm_behavior_tree/test_tree.xml";
