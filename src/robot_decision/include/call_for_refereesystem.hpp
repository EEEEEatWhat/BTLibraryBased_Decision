...
namespace robot_decision {
    ...
    public:
        ...
        bool setRobotStatus(std::shared_ptr<my_msg_interface::srv::RefereeMsg_Response> result) {
            RM_referee::RobotStatusStruct struct_;
            std::memcpy(&struct_, result->data_stream.data(), static_cast<size_t>(result->data_length));
            if(result->cmd_id == cmd_id_req) {
                blackboard_->set<uint8_t>("RobotStatusStruct.robot_id", struct_.robot_id);
                blackboard_->set<uint16_t>("RobotStatusStruct.current_exp", struct_.current_exp);
                blackboard_->set<uint16_t>("RobotStatusStruct.current_HP", struct_.current_HP);
                blackboard_->set<uint8_t>("RobotStatusStruct.power_management_gimbal_output", struct_.power_management_gimbal_output);
                blackboard_->set<uint8_t>("RobotStatusStruct.power_management_chassis_output", struct_.power_management_chassis_output);
                blackboard_->set<uint8_t>("RobotStatusStruct.power_management_shooter_output", struct_.power_management_shooter_output);
                return true;
            }
            return false;
        };
        ...
        bool setRobotPos(std::shared_ptr<my_msg_interface::srv::RefereeMsg_Response> result) {
            RM_referee::RobotPosStruct struct_;
            std::memcpy(&struct_, result->data_stream.data(), static_cast<size_t>(result->data_length));
            if(result->cmd_id == cmd_id_req) {
                blackboard_->set<float>("RobotPosStruct.x", struct_.x);
                blackboard_->set<float>("RobotPosStruct.y", struct_.y);
                blackboard_->set<float>("RobotPosStruct.angle", struct_.angle);
                return true;
            }
            return false;
        };
        ...
        bool setBuff(std::shared_ptr<my_msg_interface::srv::RefereeMsg_Response> result) {
            RM_referee::BuffStruct struct_;
            std::memcpy(&struct_, result->data_stream.data(), static_cast<size_t>(result->data_length));
            if(result->cmd_id == cmd_id_req) {
                blackboard_->set<uint8_t>("BuffStruct.recovery_buff", struct_.recovery_buff);
                blackboard_->set<uint8_t>("BuffStruct.cooling_buff", struct_.cooling_buff);
                blackboard_->set<uint8_t>("BuffStruct.defence_buff", struct_.defence_buff);
                blackboard_->set<uint16_t>("BuffStruct.attack_buff", struct_.attack_buff);
                return true;
            }
            return false;
        };
        ...
        bool setProgectileAllowance(std::shared_ptr<my_msg_interface::srv::RefereeMsg_Response> result) {
            RM_referee::ProgectileAllowanceStruct struct_;
            std::memcpy(&struct_, result->data_stream.data(), static_cast<size_t>(result->data_length));
            if(result->cmd_id == cmd_id_req) {
                blackboard_->set<uint16_t>("ProgectileAllowanceStruct.projectile_allowance_17mm", struct_.projectile_allowance_17mm);
                blackboard_->set<uint16_t>("ProgectileAllowanceStruct.projectile_allowance_42mm", struct_.projectile_allowance_42mm);
                blackboard_->set<uint16_t>("ProgectileAllowanceStruct.remaining_gold_coin", struct_.remaining_gold_coin);
                return true;
            }
            return false;
        };
        ...
        bool setRfidStatus(std::shared_ptr<my_msg_interface::srv::RefereeMsg_Response> result) {
            RM_referee::RfidStatusStruct struct_;
            std::memcpy(&struct_, result->data_stream.data(), static_cast<size_t>(result->data_length));
            if(result->cmd_id == cmd_id_req) {
                blackboard_->set<uint32_t>("RfidStatusStruct.rfid_status", struct_.rfid_status);
                return true;
            }
            return false;
        };
        ...
        bool setSentryCmd(std::shared_ptr<my_msg_interface::srv::RefereeMsg_Response> result) {
            RM_referee::SentryCmdStruct struct_;
            std::memcpy(&struct_, result->data_stream.data(), static_cast<size_t>(result->data_length));
            if(result->cmd_id == cmd_id_req) {
                blackboard_->set<uint32_t>("SentryCmdStruct.sentry_cmd", struct_.sentry_cmd);
                return true;
            }
            return false;
        };
