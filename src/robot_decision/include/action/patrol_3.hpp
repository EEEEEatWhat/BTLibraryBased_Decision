...
{
    class Patrol_3 : public BT::RosActionNode<global_interfaces::action::BehaviorTreePose>
    {
    public:
        Patrol_3(const std::string &name,
        ...
        {   
            goal.set__pose(blackboard_->get<geometry_msgs::msg::PoseStamped>("patrol_1"));
