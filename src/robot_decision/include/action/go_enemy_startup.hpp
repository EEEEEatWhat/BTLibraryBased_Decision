#ifndef GO_ENEMY_STARTUP_HPP
#define GO_ENEMY_STARTUP_HPP
...
{
    class GoEnemyStartup : public BT::RosActionNode<global_interfaces::action::BehaviorTreePose>
    {
    public:
        GoEnemyStartup(const std::string &name,
        ...
        {   
            ...
            RCLCPP_INFO(node_->get_logger(),"goal设置成功.为敌方哨兵启动区附近... ");
            return true;
        };
