#ifndef GO_OUR_BUNKER_HPP
#define GO_OUR_BUNKER_HPP
...
{
    class GoOurBunker : public BT::RosActionNode<global_interfaces::action::BehaviorTreePose>
    {
    public:
        GoOurBunker(const std::string &name,
        ...
        {   
            ...
            RCLCPP_INFO(node_->get_logger(),"goal设置成功.为我方场地掩体附近... ");
            return true;
        };
