#ifndef GO_ENEMY_OUTPOST_HPP
#define GO_ENEMY_OUTPOST_HPP
...
{
    class GoEnemyOutpost : public BT::RosActionNode<global_interfaces::action::BehaviorTreePose>
    {
    public:
        GoEnemyOutpost(const std::string &name,
        ...
        {   
            goal.set__pose(blackboard_->get<geometry_msgs::msg::PoseStamped>("enemy_outpost"));
            RCLCPP_INFO(node_->get_logger(),"goal设置成功.为敌方前哨站附近...");
            return true;
        };
        ...
        BT::NodeStatus onResultReceived(const WrappedResult &wr) override
        {
            ...
            RCLCPP_INFO(node_->get_logger(),"任务执行完毕...");
