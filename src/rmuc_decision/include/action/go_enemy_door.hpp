#ifndef GO_ENEMY_DOOR_HPP
#define GO_ENEMY_DOOR_HPP
...
{
    class GoEnemyDoor : public BT::RosActionNode<global_interfaces::action::BehaviorTreePose>
    {
    public:
        GoEnemyDoor(const std::string &name,
        ...
        {   
            goal.set__pose(blackboard_->get<geometry_msgs::msg::PoseStamped>("enemy_door"));
            RCLCPP_INFO(node_->get_logger(),"goal设置成功.为敌方基地附近...");
            return true;
        };
