#ifndef GO_OUR_OUTPOST_HPP
#define GO_OUR_OUTPOST_HPP
...
{
    class GoOurOutpost : public BT::RosActionNode<global_interfaces::action::BehaviorTreePose>
    {
    public:
        GoOurOutpost(const std::string &name,
        ...
        {   
            goal.set__pose(blackboard_->get<geometry_msgs::msg::PoseStamped>("our_outpost"));
            RCLCPP_INFO(node_->get_logger(),"goal设置成功.为自家前哨站附近...");
            return true;
        };
