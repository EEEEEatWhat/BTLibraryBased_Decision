#ifndef GO_KEYSTONE_HEIGHTS_HPP
#define GO_KEYSTONE_HEIGHTS_HPP
...
{
    class GoKeystoneHeights : public BT::RosActionNode<global_interfaces::action::BehaviorTreePose>
    {
    public:
        GoKeystoneHeights(const std::string &name,
